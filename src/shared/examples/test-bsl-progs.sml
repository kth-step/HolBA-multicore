...
val tests = [
  ...
  ("noop_prog",
    [
      (blabel_str "prologue", bmc_none, [], (bjmp o belabel_str) "epilogue"),
      (blabel_str "epilogue", bmc_none, [], (bhalt o bconst32) 0)
    ],
    ``BirProgram [
  ...
  ("simple_arith_prog",
    [
      (blabel_str "prologue", bmc_none, [], (bjmp o belabel_str) "plus_mult"),
      (blabel_str "plus_mult", bmc_none, [
