...
val bir_list_of_types = [
   ...
   mk_thy_type {Tyop="bir_label_exp_t",          Thy="bir_program", Args=[Type.alpha]},
   mk_thy_type {Tyop="bir_memop_t",              Thy="bir_program", Args=[]},
   mk_thy_type {Tyop="bir_stmt_basic_t",         Thy="bir_program", Args=[Type.alpha]},
   mk_thy_type {Tyop="bmc_stmt_basic_t",         Thy="bir_program", Args=[Type.alpha]},
   mk_thy_type {Tyop="bir_stmt_end_t",           Thy="bir_program", Args=[Type.alpha]},
   mk_thy_type {Tyop="bir_generic_stmt_t",       Thy="bir_program", Args=[Type.alpha, Type.beta]},
   mk_thy_type {Tyop="bir_mc_tags_t",            Thy="bir_program", Args=[]},
   mk_thy_type {Tyop="bir_programcounter_t",     Thy="bir_program", Args=[]},
   mk_thy_type {Tyop="bir_status_t",             Thy="bir_program", Args=[]},
   mk_thy_type {Tyop="fwdb_t",                   Thy="bir_program", Args=[]},
