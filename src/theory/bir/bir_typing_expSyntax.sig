...
sig
   ...
   val dest_type_of_bir_exp : term -> term * term
   val is_type_of_bir_exp   : term -> bool
   val mk_type_of_bir_exp   : term * term -> term
   ...
   val dest_bir_exp_is_well_typed : term -> term * term
   val is_bir_exp_is_well_typed   : term -> bool
   val mk_bir_exp_is_well_typed   : term * term -> term
