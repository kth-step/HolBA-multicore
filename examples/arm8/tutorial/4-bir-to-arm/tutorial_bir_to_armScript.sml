...
Definition bir_add_reg_pre_def:
bir_add_reg_pre =
...
Definition bir_add_reg_post_def:
bir_add_reg_post =
...
val bir_add_reg_loop_condition = 
 bnot ``(BExp_BinExp BIExp_Or
...
Definition bir_add_reg_loop_condition_def:
 bir_add_reg_loop_condition = ^bir_add_reg_loop_condition
End

Definition bir_add_reg_I_def:
bir_add_reg_I =
^(bandl [
...
Definition bir_add_reg_contract_1_pre_def:
bir_add_reg_contract_1_pre =
 bir_add_reg_pre
End

Definition bir_add_reg_contract_1_post_def:
 bir_add_reg_contract_1_post =
  bir_add_reg_I
End
...
Definition bir_add_reg_contract_2_pre_def:
bir_add_reg_contract_2_pre =
 ^(band(``bir_add_reg_I``, bir_add_reg_loop_condition))
End

Definition bir_add_reg_contract_2_post_def:
bir_add_reg_contract_2_post =
 bir_add_reg_I
End
...
Definition bir_add_reg_contract_3_pre_def:
bir_add_reg_contract_3_pre =
^(band(``bir_add_reg_I``, bir_add_reg_loop_condition))
End

Definition bir_add_reg_contract_3_post_def:
bir_add_reg_contract_3_post =
  ^(band(``bir_add_reg_I``, bir_add_reg_loop_condition))
End
...
Definition bir_add_reg_contract_4_pre_def:
bir_add_reg_contract_4_pre =
^(band(``bir_add_reg_I``, bnot bir_add_reg_loop_condition))
End

Definition bir_add_reg_contract_4_post_def:
bir_add_reg_contract_4_post =
 bir_add_reg_post
End
...
Definition bir_add_reg_contract_2_pre_variant_def:
bir_add_reg_contract_2_pre_variant v =
^(bandl[``bir_add_reg_I``, bir_add_reg_loop_condition,
  beq(get_lx, get_v)])
End

Definition bir_add_reg_contract_2_post_variant_def:
...
Definition bir_add_reg_contract_3_pre_variant_def:
bir_add_reg_contract_3_pre_variant v =
^(bandl[``bir_add_reg_I``, bir_add_reg_loop_condition, beq(get_lx, get_v)])
End

Definition bir_add_reg_contract_3_post_variant_def:
bir_add_reg_contract_3_post_variant v =
 ^(bandl[``bir_add_reg_I``, bir_add_reg_loop_condition, beq(get_lx, get_v)])
End

(* contract entry mem *)
Definition bir_add_reg_contract_0_pre_def:
bir_add_reg_contract_0_pre =
^(bandl [bnot (bslt(get_r0, bconst64 0)),
...
Definition bir_add_reg_contract_0_post_def:
 bir_add_reg_contract_0_post = bir_add_reg_pre
End
...
Theorem bir_add_reg_pre_is_bool_pred_thm[local]:
...
Theorem arm8_pre_imp_bir_pre_thm:
...
Theorem arm8_post_imp_bir_post_thm:
!(ls:bir_label_t -> bool).
