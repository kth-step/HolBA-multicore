...
val s3_thm =
  let
    ...
    val s3_prog_def = bdefprog_list alpha "s3_prog" [
      (blabel_str "entry", bmc_none, [], (bjmp o belabel_str) "ret_eq_0"),
      (blabel_str "ret_eq_0", bmc_none, [
...
val s2_thm =
  let
    ...
    val s2_prog_def = bdefprog_list alpha "s2_prog" [
      (blabel_str "entry", bmc_none, [], (bjmp o belabel_str) "ret_add_x"),
      (blabel_str "ret_add_x", bmc_none, [
        bassign (bvarimm16 "ret", bplus ((bden o bvarimm16) "ret", (bden o bvarimm16) "x"))
      ], (bjmp o belabel_str) "x_dec"),
      (blabel_str "x_dec", bmc_none, [
